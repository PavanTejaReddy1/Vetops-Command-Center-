...
const CURRENT_USER = { name: 'Jordan Blake', role: 'Operations Manager' };
            ...
            <>
              ...
              <div className="absolute right-0 z-20 mt-2 w-52 animate-fade-up rounded-lg border border-border bg-surface-raised p-1.5 shadow-popover">
                <div className="px-2.5 py-2">
                  ...
                  <p className="text-xs text-ink-faint">{CURRENT_USER.role}</p>
                </div>
                ...
                <button className="w-full rounded-md px-2.5 py-2 text-left text-sm text-signal-rose hover:bg-signal-rose-soft">
                  Sign out
                </button>
              </div>
            </>
